...
filling_prices["officesupplies"]=400;
 ...
 website_prices["Yes"]=0;
 website_prices["No"]=350;
...
{  
    ...
    //Get a reference to the website the user Chooses name=newsletter":
    var newsletter = theForm.elements["newsletter"];
    //Here since there are 4 radio buttons newsletter.length = 4
    ...
    for(var i = 0; i < newsletter.length; i++)
    {
        ...
        if(newsletter[i].checked)
        {
            ...
            websiteSizePrice = website_prices[newsletter[i].value];
...
function calculateTotal()
{
	...
	var divobjjj = document.getElementById('totalPrice2');
    divobj.style.display='block';
    divobj.innerHTML = "$"+websitePrice;
	 divobjj.innerHTML = "$"+websitePrice;
	divobjjj.innerHTML = "$"+websitePrice;
